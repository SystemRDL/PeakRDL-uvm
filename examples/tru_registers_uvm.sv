...
`define TRU_REGISTERS_UVM_SV
    ...
    //-----------------------------------------------------------------------------
    class trigger_routing_unit__tru_ssrn extends uvm_reg_enhanced;
    ...
    //-----------------------------------------------------------------------------
    class trigger_routing_unit__tru_mtr extends uvm_reg_enhanced;
    ...
    //-----------------------------------------------------------------------------
    class trigger_routing_unit__tru_erraddr extends uvm_reg_enhanced;
    ...
    //-----------------------------------------------------------------------------
    class trigger_routing_unit__tru_stat extends uvm_reg_enhanced;
    ...
    //-----------------------------------------------------------------------------
    class trigger_routing_unit__tru_gctl extends uvm_reg_enhanced;
    ...
    //-----------------------------------------------------------------------------
    class trigger_routing_unit__tru_rxdata extends uvm_reg_enhanced;
    ...
    class trigger_routing_unit extends uvm_reg_block;
        ...
        virtual function void build();
            ...
            this.default_map.add_reg(.rg(this.TRU_RXDATA), .offset(32'h201c), .rights("RW"));
